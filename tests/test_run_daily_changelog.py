...
def test_changelog_prefers_job_id_over_url_changes(tmp_path: Path) -> None:
    prev_jobs = [
        _job("https://example.com/a", "A Role", 100, "alpha"),
    ]
    prev_jobs[0]["job_id"] = "job-1"
    curr_jobs = [
        _job("https://example.com/b", "A Role", 100, "alpha"),
    ]
    curr_jobs[0]["job_id"] = "job-1"
